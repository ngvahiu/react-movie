...
import { addFilmAction } from '../../../../redux/reducers/FilmManagementReducer/FilmManagementActions';
...
const AddNewFilm = () => {
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addFilmAction(filmValues, form.resetFields));
  }

  return (
    <div className='grid grid-cols-2'>
      <div>
        <h1 className='text-4xl font-semibold mb-5'>Add new film</h1>
        <Form
          labelCol={{
            span: 4,
          }}
        ...
        >
          <Form.Item name="tenPhim" label="Film name" rules={[
            {
              required: true,
              message: '*Required'
            }
